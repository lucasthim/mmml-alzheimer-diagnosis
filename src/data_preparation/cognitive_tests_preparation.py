...
arg_parser.add_argument('-i','--input',
                    ...
                    type=str,
                    required=False,
                    default='/content/gdrive/MyDrive/Lucas_Thimoteo/mmml-alzheimer-diagnosis/data/tabular/',
...
def execute_cognitive_data_preparation(input_path,output_path,exclude_ecog_tests=True):
    ...
    df_adni_merge.to_csv(output_path + "COGNITIVE_DATA_PROCESSED.csv",index=False)
...
def main():
    execute_cognitive_data_preparation(args.input,args.output,args.exclude)
