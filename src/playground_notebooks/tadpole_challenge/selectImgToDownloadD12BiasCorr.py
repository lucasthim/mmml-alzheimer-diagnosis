...
print("Images with MRI scan", imageIDs2.shape) # with MRI scan
print("Images with MRI scan and ventricle passing QC", imageIDs3.shape) # with MRI scan and ventricle passing QC
